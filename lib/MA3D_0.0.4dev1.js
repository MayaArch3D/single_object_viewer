...
MA3D.Dialog.AddPointAlignmentMaterial = function(scene, containerDiv) {
	...
	var observerPointMaterial = new THREE.ParticleBasicMaterial({
	...
	var observerPoint   = new THREE.ParticleSystem(observerPointGeom, observerPointMaterial);
...
MA3D.AnalysisDialog.LineOfSight = function(scene, containerDiv) {
	...
	var targetPointMaterial = new THREE.ParticleSystemMaterial({
												color:new THREE.Color(0x00ffff),
												sizeAttenuation:false,
												size:32,
												map:pickSymbol,
	...
	var targetPoint   = new THREE.ParticleSystem(targetPointGeom, targetPointMaterial);
