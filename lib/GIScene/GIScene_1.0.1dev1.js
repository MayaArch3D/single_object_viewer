...
GIScene.Control.Pick = function(camera, config){
	...
	// var imageTexture = new THREE.Texture(null);
		...
		// };
		// img.src = GIScene.LIBRARYPATH + GIScene.RESOURCESPATH.replace(/([^\/])$/, "$1/") +"resources/images/particle_cross.png";
// 	
	// var pickSymbol  = imageTexture;
...
GIScene.Process.LineOfSight_simpleClient = function() {
	...
	this.execute = function(onExecute) {
		...
		var checkUncachedTile = function(index, layer, loading, controlArray, uncachedTiles, uncachedTilesIndex, computeTileIndicesHandler, nearestIntersectionTileIndex) {
			...
			console.log("Loading Requests:" , loading);
...
GIScene.Grid.Index.prototype = {
	...
	getChildNW	: function() {
						var x = this.x * 2;
						var y = this.y * 2 + 1;
						return new GIScene.Grid.Index(x,y,this.tileSize/2);
				},
	getChildSW	: function() {
						var x = this.x * 2;
						var y = this.y * 2;
...
// 			
		...
		//@param poly {Array of Objects with x and y property}
